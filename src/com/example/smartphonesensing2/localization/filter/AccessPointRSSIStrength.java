package com.example.smartphonesensing2.localization.filter;
...
public class AccessPointRSSIStrength {
    ...
    private ArrayList<String> filtered_ap = new ArrayList<String>();
	...
	public TreeMap <String, Float> fetch_AP_and_RSSIavg()	{
	...
	public void save_filtered_AP( ){
	 ...
	 public void filter_rssi_too_strong_Tree(TreeMap<String,Float> data){
	 ...
	 public void filter_rssi_too_strong(){
	...
	public float get_mean(float [] data){
	...
	/* get stadard divation of an array */
	 public float get_standardDeviation(float []data, float data_mean){
		float std=(float)0;
