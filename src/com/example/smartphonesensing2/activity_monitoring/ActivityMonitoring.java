...
//		activities = knn.get_activities();
	...
	private void splitTrainingData() {
		...
		int trainingDatasetStill_percentage = (int)(trainingDatasetStill.size() * 0.5);
		int trainingDatasetWalk_percentage = (int)(trainingDatasetWalk.size() * 0.5);
		int trainingDatasetRun_percentage = (int)(trainingDatasetRun.size() * 0.5);
		int trainingDatasetJump_percentage = (int)(trainingDatasetJump.size() * 0.5);
